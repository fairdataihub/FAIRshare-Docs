...
image: https://kalai.fairdataihub.org/api/generate?app=fairshare&title=Download%20FAIRshare&description=Getting%20Started&org=fairdataihub
---
...
:::note
When uninstalling FAIRshare on Windows, some additional files might not be removed from the system. To manually remove these items, you can delete the `C:\Users\[username]\AppData\Local\Programs\fairshare` folder.
:::
