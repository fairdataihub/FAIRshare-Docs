...
:::note
When uninstalling SODA for COVID-19 Research on Windows, some additional files might not be removed from the system. To manually remove these items, you can delete the `C:\Users\[username]\AppData\Local\Programs\soda-for-covid-19-research` folder.
:::
