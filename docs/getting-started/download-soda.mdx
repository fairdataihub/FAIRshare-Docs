...
Since our Linux FAIRshare app is in the AppImage format, you can move this file anywhere on your computer and run it. If you would like to move the app into the applications older, we recommend you use the open-source [AppImage Launcher](https://github.com/TheAssassin/AppImageLauncher) to organize and handle all AppImage programs for your Linux system.
